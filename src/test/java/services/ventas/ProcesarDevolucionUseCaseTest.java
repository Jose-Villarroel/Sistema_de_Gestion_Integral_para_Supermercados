...
class ProcesarDevolucionUseCaseTest {
    ...
    class ProcesarDevolucionValidaciones {
         ...
         * Como esta validacion esta antes del try, viene como IllegalArgumentException directa.
         */
        @Test
    ...
    class ProcesarDevolucionFlujos {
        ...
        void itemConCantidadCero_seIgnora() throws Exception {
            ...
            var solicitud = solicitudExitosa(5,
                    List.of(
                            new ItemDevolucion(5, 0, "ignorar", EstadoProductoDevolucion.CERRADO),
                            new ItemDevolucion(5, 1, "valido", EstadoProductoDevolucion.CERRADO)
                    ),
                    MetodoReembolso.NOTA_CREDITO);
